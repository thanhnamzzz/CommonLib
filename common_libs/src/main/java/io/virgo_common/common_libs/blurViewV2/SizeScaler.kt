...
import io.virgo_common.common_libs.blurViewV2.SizeScaler.Companion.ROUNDING_VALUE
...
class SizeScaler @JvmOverloads constructor(
    ...
    private fun roundSize(value: Int): Int {
        if (noStrideAlignment) return value
        return if (value % ROUNDING_VALUE == 0) value
